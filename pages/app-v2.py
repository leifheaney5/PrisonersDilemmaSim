...
from game_logic import Game, strategies, summarize_results, create_match_history_figure, calculate_longest_streak

# Initialize the game and play all matches
game = Game()
...
def update_history_graph(selected_strategy, selected_opponent):
    ...
    metrics = html.Div([
        ...
        html.P(f"Percentage of Rounds Won: {win_percentage:.2f}%"),
