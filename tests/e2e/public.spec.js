...
test("profiles render the 100-strategy landscape and profile selector", async ({ page }) => {
  ...
  await expect(page.getByText("See all 100 strategies at once", { exact: false })).toBeVisible();
});
